...
- Name: Sprint_4___Checkout/automatisation/tests/signin.spec.ts >> Sign In dans le checkout >> TC-002 - Login avec credentials valides (accès vers Billing Address)
- Location: Sprint_4___Checkout/automatisation/tests/signin.spec.ts:63:3
