...
- Name: Sprint_4___Checkout/automatisation/tests/billing-address.spec.ts >> Billing Address >> TC-007 - Champs obligatoires vides
- Location: Sprint_4___Checkout/automatisation/tests/billing-address.spec.ts:76:3
...
Call log:
  ...
  - waiting for locator('[data-test="proceed-3"]')
    14 × locator resolved to <button type="button" awnextstep="" data-test="proceed-3" class="btn btn-success" _ngcontent-ng-c1226357352="">          </button>
