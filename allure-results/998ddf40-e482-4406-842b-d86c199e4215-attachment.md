...
- Name: Sprint_4___Checkout/automatisation/tests/signin.spec.ts >> Sign In dans le checkout >> TC-001 - Vérifier que la section Sign In est accessible depuis le checkout
- Location: Sprint_4___Checkout/automatisation/tests/signin.spec.ts:56:3
