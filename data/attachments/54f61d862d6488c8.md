...
Call log:
  ...
  - waiting for locator('[data-test="nav-user-menu"]')
    11 × locator resolved to <a href="#" role="button" id="user-menu" aria-expanded="false" data-test="nav-user-menu" data-bs-toggle="dropdown" _ngcontent-ng-c2781432996="" class="nav-link dropdown-toggle"> User Data not found </a>
